...
/*
    ...
    be stored in the portrait's respective portrait position place in
...
function resetPage(back, forward) {
    ...
    for(i = 0; i < lpc.length; i++) {
        if(lpc[i] != -1) {
            ...
            for(j = 0; j < portraitpg.pdirection.length; j++) {
                if(portraitpg.pdirection[j].position == i + 1) {
                    switch(portraitpg.pdirection[j].position) {
                        case 1:
                            break;
                        case 2:
                            changePortrait("#leftPortraitPair", portraitpg.pdirection[j].url);
                            break;
                        case 3:
                            changePortrait("#centerPortrait", portraitpg.pdirection[j].url);
                            break;
                        case 4:
                            changePortrait("#rightPortraitPair", portraitpg.pdirection[j].url);
                            break;
                        case 5:
                            break;
                        default:
        ...
        } else if (lpc[i] == -1) { //portrait was not there earleir

            switch(i+1) {
                case 1:
                    break;
                case 2:
                    $("#leftPortraitPair").fadeOut(100);
                    break;
                case 3:
                    $("#centerPortrait").fadeOut(100);
                    break;
                case 4:
                    $("#rightPortraitPair").fadeOut(100);
                    break;
                case 5:
                    break;
                default:
